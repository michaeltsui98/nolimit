 ...
 * 心理健康咨询资讯相关模型
 */
class Models_Teacher_TeacherInterface  extends Cola_Model {
    private $_teacher_info_model = "";
    private $_user_app_model = NULL;
    /**
     * 构造函数
     */
    ...
    {
        return $this->_user_app_model->getAppByNoMobile($role,$xk_code,1,999999);
    }
