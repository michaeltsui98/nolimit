...
var initList = function () {
    ...
    var getListData = function () {
        AjaxForJson(commonParams.jcDevPath + commonParams.jcType + "/Parent/evaluateHistoryAjax", 'p=' + evaluatePorms.page.toString() + '&evaluate_type=' + evaluatePorms.tabName + '&bb=' + $('[name="bb"]').find("option:selected").val() + '&nj=' + $('[name="nj"]').find("option:selected").val() + '&evaluate_record_status=' + $('[name="evaluate_record_status"]').find("option:selected").val(), function (data) {
            if (data.data != null) {
