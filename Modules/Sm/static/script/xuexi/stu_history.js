var initList = function () {
    var getHistroyList = function () {
        //如果是知识节点 则需要分页
        var url = commonParams.jcDevPath + commonParams.jcType + "/Study/studyHistoryMoreAjaxByNode";
        ...
        if (stu_detailPorms.currentTab == 'history') {
            ...
            url = commonParams.jcDevPath + commonParams.jcType + "/Study/studyHistoryMoreAjax";
        }
