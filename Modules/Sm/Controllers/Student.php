 ...
 * @author libo
 */
class Modules_Sm_Controllers_Student extends Modules_Sm_Controllers_Base
{
   ...
   public function ajaxProcessTextbookPublisherAction()
   {
    ...
    public function recommendAction()
    {
      if(!isset($this->user_info) || empty($this->user_info)){
         ...
         //推荐的评测
         $recommend_evaluate = Models_Evaluate_Evaluate::init()->recommendEvaluate($this->view->xk_code,4);
