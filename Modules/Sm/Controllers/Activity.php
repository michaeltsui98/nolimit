 ...
 * 前台研训控制器
 */
class Modules_Sm_Controllers_Activity extends  Modules_Sm_Controllers_Base {
    ...
    public function __construct(){
        ...
        if(DODOJC == 'http://jc.dodoedu.com'){
            $this->_activity_news_element_id = 7182;
        }else{
...
//            var_dump($_SESSION);
//            var_dump($user_school_info_result);
...
//        var_dump($activity_avg_evaluate_result);
        $this->view->activity_user_evaluate = $activity_user_evaluate_result;
//        var_dump($this->view->activity_info);
