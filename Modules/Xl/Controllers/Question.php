 ...
 */
class Modules_Xl_Controllers_Question extends Modules_Xl_Controllers_Base
{
    ...
    public function dAction()
    {
        //
        /*
          $i = new Models_Question_Interfaces();
          $data=$i->getQuestionCountByUser($this->user_info['user_id'], $this->view->xk_code);
          var_dump($data);
          exit;
         *
         */
    ...
    public function send($chang_data)
    {
        ...
        $student_info = $this->_mod_question->teacherOfSomeStudent($this->user_info['user_id'], $this->view->xk_code);
    ...
    public function addAjaxAction()
    {
        $user_id = $this->user_info['user_id'];
        $subject = $this->view->xk_code;
        $student_info = $this->_mod_question->teacherOfSomeStudent($user_id, $subject);
    ...
    public function myAjaxAction()
    {
        ...
        $data += array(
            'user_id' => $this->user_info['user_id'],
            'order' => in_array($order, array('timeOrder', 'hotOrder')) ? $order : 'timeOrder'
        );
        if ($type == 'Answer') {
            $data +=array(
                'page' => $page,
