...
class Modules_Xl_Controllers_Resource extends  Modules_Xl_Controllers_Base {
	...
	public function viewAction(){
	   ...
	   // var_dump($tag_info);
	    ...
	    //Models_Resource::init()->getRecommendResource()
	...
	public function relateResource($limit){
		 ...
		 //Models_Resource::init()->getRecommendResource($this->view->info['xd'],$)
	}
