...
<div id="keke_error">
  ...
  <div id="<?php echo $error_id;?>" class="content">
    <p><span class="file"><?php echo Cola_Exception_Debug::path($file); ?>[ <?php echo $line;?> ]</span></p>
    <?php echo Cola_Exception_Debug::source($file, $line); ?>
    <ol class="trace">
 ...
 <span class="file">
  ...
  <?php $source_id = $error_id.'source'.$i; ?>
          <a href="# <?php echo $source_id?>" onClick="return koggle('<?php echo $source_id?>')">
          	<?php echo Cola_Exception_Debug::path($step['file']); ?> [ <?php echo $step['line'];?> ]</a>
          <?php } else { ?>
  ...
  <div id="<?php echo $env_id?>" class="content collapsed">
    ...
    <div id="<?php echo $env_id?>" class="collapsed">
      <table cellspacing="0">
        ...
        <tr>
          <td><code><?php echo Cola_Exception_Debug::path($file); ?></code></td>
        </tr>
        <?php } } ?>
      </table>
    </div>
