 ...
 */
abstract class Orm_Database_Query_Builder extends Orm_Database_Query {
	 ...
	 * @return  string
	 */
	protected function _compile_join(Orm_Database $db, array $joins)
	{
		$statements = array();
	 ...
	 * @return  string
	 */
	protected function _compile_conditions(Orm_Database $db, array $conditions)
	{
		$last_condition = NULL;
	 ...
	 * @return  string
	 */
	protected function _compile_set(Orm_Database $db, array $values)
	{
		$set = array();
	 ...
	 * @return  string
	 */
	protected function _compile_group_by(Orm_Database $db, array $columns)
	{
		$group = array();
	 ...
	 * @return  string
	 */
	protected function _compile_order_by(Orm_Database $db, array $columns)
	{
		$sort = array();
