 ...
 */
class Orm_Database_Query_Builder_Select extends Orm_Database_Query_Builder_Where {
	...
	public function __construct(array $columns = NULL)
	{
		...
		parent::__construct(Orm_Database::SELECT, '');
	}
	...
	{
		$this->_join[] = $this->_last_join = new Orm_Database_Query_Builder_Join($table, $type);
	...
	public function union($select, $all = TRUE)
	{
		if (is_string($select))
		{
			$select = Orm_DB::select()->from($select);
		}
		if ( ! $select instanceof Orm_Database_Query_Builder_Select)
			throw new Cola_Exception('first parameter must be a string or an instance of Database_Query_Builder_Select');
