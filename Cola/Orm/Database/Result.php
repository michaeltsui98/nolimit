 ...
 */
abstract class Orm_Database_Result implements Countable, Iterator, SeekableIterator, ArrayAccess {
	...
	{
		return new Orm_Database_Result_Cached($this->as_array(), $this->_query, $this->_as_object);
	}
	...
	{
		throw new Cola_Exception('Database results are read-only');
	}
