...
class Orm_DB {
	 ...
	 * @return  Orm_Database_Query
	 */
	public static function query($type, $sql)
	{
		return new Orm_Database_Query($type, $sql);
	}
	 ...
	 * @return  Orm_Database_Query_Builder_Select
	 */
	public static function select($columns = NULL)
	{
		return new Orm_Database_Query_Builder_Select(func_get_args());
	}
	...
	{
		return new Orm_Database_Query_Builder_Select($columns);
	}
	 ...
	 * @return  Orm_Database_Query_Builder_Insert
	 */
	public static function insert($table = NULL, array $columns = NULL)
	{
		return new Orm_Database_Query_Builder_Insert($table, $columns);
	}
	 ...
	 * @return  Orm_Database_Query_Builder_Update
	 */
	public static function update($table = NULL)
	{
		return new Orm_Database_Query_Builder_Update($table);
	}
	 ...
	 * @return  Orm_Database_Query_Builder_Delete
	 */
	public static function delete($table = NULL)
	{
		return new Orm_Database_Query_Builder_Delete($table);
	}
	 ...
	 * @return  Orm_Database_Expression
	 */
	public static function expr($string, $parameters = array())
	{
		return new Orm_Database_Expression($string, $parameters);
	}
